...
public class playerprofile extends javax.swing.JFrame implements ActionListener {
    ...
    {
            j1=new JFrame("Player profile page");
            j1.setLayout(null);
            j1.setSize(715, 950);
            j1.setVisible(true);
    ...
    public playerprofile(String s){
     ...
     {
         j1.dispose();
         j2=new JFrame("Add player details page");
            j2.setLayout(null);
            j2.setSize(715, 950);
            j2.setVisible(true);
     ...
     void edit(String b)
    {
        try {
            for (i = 1; i <10; i++) {
                ...
                stmt = connection.con.prepareStatement("Select * from " + cn.teamsare[i] + " where PLAYER=?");
                stmt.setString(1, b);
                rs = stmt.executeQuery();
                while (rs.next()) {
                   tp1.setText(b);
                   tp2.setText(cn.teamsare[i]);
                   tp3.setText("20");
                   tt1[0].setText(String.valueOf(rs.getInt(3)));
                   tt1[1].setText(String.valueOf(rs.getInt(4)));
                   tt1[2].setText(String.valueOf(rs.getInt(5)));
                   tt1[3].setText(String.valueOf(rs.getInt(6)));
                   tt1[4].setText(String.valueOf(rs.getInt(7)));
                   tt1[5].setText(String.valueOf(rs.getInt(8)));
                   tt1[6].setText(String.valueOf(rs.getInt(9)));
                   tt1[7].setText(String.valueOf(rs.getInt(10)));
                   tt2[0].setText(String.valueOf(rs.getInt(13)));
                   tt2[1].setText(String.valueOf(rs.getInt(14)));
                   tt2[2].setText(String.valueOf(rs.getInt(15)));
                   tt2[3].setText(String.valueOf(rs.getInt(11)));
                   tt2[4].setText(String.valueOf(rs.getInt(12)));
                   }
               }}
     ...
     {
         try{
            stmt=connection.con.prepareStatement("update "+tp2.getText()+" set PLAYER=?,TESTBAT=?,ODIBAT=?,T20BAT=?,RUNS=?,FOURS=?,SIX=?,CENTURY=?,FIFTY=?,OVERS=?,WICKETS=?,TESTBALL=?,ODIBALL=?,T20BALL=? where PLAYER=?");
          stmt.setString(1, tp1.getText());
          stmt.setInt(2, Integer.parseInt(tt1[0].getText()));
          stmt.setInt(3, Integer.parseInt(tt1[1].getText()));
          stmt.setInt(4, Integer.parseInt(tt1[2].getText()));
          stmt.setInt(5, Integer.parseInt(tt1[3].getText()));
          stmt.setInt(6, Integer.parseInt(tt1[4].getText()));
          stmt.setInt(7, Integer.parseInt(tt1[5].getText()));
          stmt.setInt(8, Integer.parseInt(tt1[6].getText()));
          stmt.setInt(9, Integer.parseInt(tt1[7].getText()));
          stmt.setFloat(10, Float.parseFloat(tt2[0].getText()));
          stmt.setInt(11, Integer.parseInt(tt2[1].getText()));
          stmt.setInt(12, Integer.parseInt(tt2[2].getText()));
          stmt.setInt(13, Integer.parseInt(tt2[3].getText()));
          stmt.setInt(14, Integer.parseInt(tt2[4].getText()));
          stmt.setString(15, tp1.getText());
          stmt.executeUpdate();   
     ...
     void add()
     {
          int n=0;
          try{
           stmt=connection.con.prepareStatement("select count(*) from "+tp2.getText());
            rs=stmt.executeQuery();
            while(rs.next())
            n=rs.getInt("count(*)");
            if(n<33)
            {
           stmt=connection.con.prepareStatement("insert into "+tp2.getText()+" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
          stmt.setInt(1, n+1);
          ...
          stmt.setFloat(11, Float.parseFloat(tt2[0].getText()));
          stmt.setInt(12, Integer.parseInt(tt2[1].getText()));
          stmt.setInt(13, Integer.parseInt(tt2[2].getText()));
          stmt.setInt(14, Integer.parseInt(tt2[3].getText()));
          stmt.setInt(15, Integer.parseInt(tt2[4].getText()));
          stmt.setString(16, tp3.getText());
          stmt.executeUpdate();   
